...
export const ThemeProvider: FC<PropsWithChildren<ThemeProviderProps>> = ({
  ...
  // Our saved theme context: can be "light", "dark", or undefined (app default)
   ...
   * themeScheme is the value from MMKV (set via the Settings screen). If the
   * user has never overridden it, the app defaults to "dark" rather than
   * following the device's own light/dark setting — this app's palette
   * (colors.ts/colorsDark.ts) was authored as a single dark UI mirroring
   * ai-project-android, so "light" isn't a real second look to fall back to.
   */
