...
const networking = (pluginConfig = {}) => reactotron => {
   ...
   */
  function onFetchOpen(method, url, headers, data, id) {
   ...
   */
  function onFetchResponse(id, status, headers, response, error) {
    ...
    const report = body => reactotron.apiResponse(tronRequest, {
      body,
      status,
      headers
    }, stopTimer());
