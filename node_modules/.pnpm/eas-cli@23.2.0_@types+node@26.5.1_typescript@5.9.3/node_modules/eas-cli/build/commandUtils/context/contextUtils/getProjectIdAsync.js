...
const accountSelection_1 = require("../../../project/accountSelection");
...
const projectNotConfiguredError_1 = require("../../../project/projectNotConfiguredError");
 ...
 */
async function chooseAccountNameForEASProjectAsync(exp, actor, options) {
    if (exp.owner) {
        return exp.owner;
    }
    if (actor.__typename === 'Robot') {
        throw (0, projectNotConfiguredError_1.getUnconfiguredProjectError)({
            actor,
    ...
    if (options.nonInteractive) {
        throw (0, projectNotConfiguredError_1.getUnconfiguredProjectError)({ actor });
    }
    const choices = (0, accountSelection_1.getAccountChoices)(actor, (0, accountSelection_1.getAccountNamesWhereUserHasSufficientPermissionsToCreateApp)(actor));
