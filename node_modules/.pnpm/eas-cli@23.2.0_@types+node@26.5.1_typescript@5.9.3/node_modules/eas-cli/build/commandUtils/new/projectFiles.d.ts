...
export declare function updatePackageJsonAsync(projectDir: string, projectName: string): Promise<void>;
export declare function removeTemplateFilesAsync(projectDir: string): Promise<void>;
