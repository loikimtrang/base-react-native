...
exports.removeTemplateFilesAsync = removeTemplateFilesAsync;
...
async function updatePackageJsonAsync(projectDir, projectName) {
...
async function removeTemplateFilesAsync(projectDir) {
    await fs_extra_1.default.remove(path_1.default.join(projectDir, 'LICENSE'));
}
