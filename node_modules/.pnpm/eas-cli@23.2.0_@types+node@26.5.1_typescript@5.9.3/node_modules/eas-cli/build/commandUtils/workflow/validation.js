...
const compositeFunctions_1 = require("./compositeFunctions");
...
async function validateWorkflowFileAsync(workflowFileContents, projectDir, graphqlClient, projectId) {
    ...
    log_1.default.debug(`Validating workflow local composite functions...`);
    await (0, compositeFunctions_1.validateWorkflowLocalCompositeFunctionsAsync)(parsedYaml, projectDir);
