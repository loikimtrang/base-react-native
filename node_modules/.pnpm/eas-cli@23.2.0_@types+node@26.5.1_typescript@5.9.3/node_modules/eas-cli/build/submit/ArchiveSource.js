...
function formatBuildChoice(build) {
    const { id, updatedAt, runtime, buildProfile, gitCommitHash, gitCommitMessage, updateChannel, message, status, } = build;
    ...
    const descriptionItems = [
        ...
        { name: 'Channel', value: updateChannel ? chalk_1.default.bold(updateChannel.name) : null },
        { name: 'Runtime version', value: runtime ? chalk_1.default.bold(runtime.version) : null },
