...
exports.isKnownMetricName = isKnownMetricName;
 ...
 */
function isKnownMetricName(input) {
    return (input in exports.METRIC_ALIASES ||
        input in exports.NAVIGATION_METRIC_ALIASES ||
