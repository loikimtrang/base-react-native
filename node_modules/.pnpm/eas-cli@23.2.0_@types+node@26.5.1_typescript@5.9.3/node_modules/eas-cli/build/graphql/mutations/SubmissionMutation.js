...
exports.SubmissionMutation = {
    ...
    async cancelSubmissionAsync(graphqlClient, submissionId) {
        const data = await (0, client_1.withErrorHandlingAsync)(graphqlClient
            .mutation((0, graphql_tag_1.default) `
    ...
    async retrySubmissionAsync(graphqlClient, parentSubmissionId) {
        const data = await (0, client_1.withErrorHandlingAsync)(graphqlClient
            .mutation((0, graphql_tag_1.default) `
          ...
          `, { parentSubmissionId })
            .toPromise());
        return (0, nullthrows_1.default)(data.submission.retrySubmission.submission);
    },
};
