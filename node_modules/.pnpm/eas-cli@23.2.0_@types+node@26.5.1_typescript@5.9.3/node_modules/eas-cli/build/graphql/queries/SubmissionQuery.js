...
const SubmissionWithSubmittedBuild_1 = require("../types/SubmissionWithSubmittedBuild");
exports.SubmissionQuery = {
    ...
    async byIdWithSubmittedBuildAsync(graphqlClient, submissionId) {
        const data = await (0, client_1.withErrorHandlingAsync)(graphqlClient
            .query((0, graphql_tag_1.default) `
            ...
            ${(0, graphql_1.print)(SubmissionWithSubmittedBuild_1.SubmissionWithSubmittedBuildFragmentNode)}
          `, { submissionId }, { additionalTypenames: ['Submission'] })
            .toPromise());
        return data.submissions.byId;
    },
