...
class ObserveRoutes extends EasCommand_1.default {
    ...
    async runAsync() {
        ...
        const { routes, pageInfoByPlatform } = await (0, planGating_1.withObservePlanGateHandlingAsync)(() => (0, fetchNavigationRoutes_1.fetchObserveNavigationRoutesAsync)(graphqlClient, projectId, {
            startTime,
            endTime,
            platforms,
