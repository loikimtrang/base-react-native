...
class Submit extends EasCommand_1.default {
    ...
    static flags = {
        ...
        'auto-testflight-setup': core_1.Flags.boolean({
            default: true,
            allowNo: true,
    ...
    sanitizeFlags(flags) {
        const { platform, verbose, wait, profile, 'non-interactive': nonInteractive, 'auto-testflight-setup': autoTestFlightSetup, 'verbose-fastlane': isVerboseFastlaneEnabled, groups, 'what-to-test': whatToTest, ...archiveFlags } = flags;
