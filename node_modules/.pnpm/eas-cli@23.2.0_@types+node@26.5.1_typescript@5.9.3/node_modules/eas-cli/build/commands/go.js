...
exports.toRepackTargetSdkVersion = toRepackTargetSdkVersion;
...
function toRepackTargetSdkVersion(sdkVersion) {
    const coerced = semver_1.default.coerce(sdkVersion);
    return coerced ? `${coerced.major}.0.0` : sdkVersion;
}
async function setupTestFlightAsync(ascApp) {
    await (0, ensureTestFlightGroup_1.ensureTestFlightGroupExistsAsync)(ascApp);
}
...
class Go extends EasCommand_1.default {
    ...
    static flags = {
        ...
        'sdk-version': core_1.Flags.string({
            description: 'Expo Go SDK version to prepare, for example 57 (default: the SDK version of the current project)',
            required: false,
        }),
    ...
    async runAsync() {
        ...
        const detectedSdkVersion = await (0, detectProjectSdkVersionAsync_1.detectProjectSdkVersionAsync)(process.cwd());
