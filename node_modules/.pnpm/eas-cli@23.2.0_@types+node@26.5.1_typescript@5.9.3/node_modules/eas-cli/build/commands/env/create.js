...
class EnvCreate extends EasCommand_1.default {
    static description = 'create an environment variable for the current project or account (deprecated, use eas env:set)';
    static hidden = true;
    static args = {
    ...
    async runAsync() {
        log_1.default.warn('This command is deprecated. Use eas env:set instead.');
