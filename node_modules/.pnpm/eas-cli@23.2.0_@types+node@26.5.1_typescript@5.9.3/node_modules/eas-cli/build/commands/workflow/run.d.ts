...
export declare function resolveWorkflowRunSshInput({ ssh, idleTimeoutSeconds, }: {
    ssh: boolean;
...
export default class WorkflowRun extends EasCommand {
    ...
    static flags: {
        ...
        ssh: import("@oclif/core/lib/interfaces").BooleanFlag<boolean>;
        'ssh-idle-timeout': import("@oclif/core/lib/interfaces").OptionFlag<number | undefined, import("@oclif/core/lib/interfaces").CustomOptions>;
