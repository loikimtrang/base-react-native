...
const sdkVersion_1 = require("../../commandUtils/new/sdkVersion");
...
async function generateProjectFilesAsync(projectDir, app, packageManager) {
    ...
    await (0, projectFiles_1.updatePackageJsonAsync)(projectDir, app.slug);
    await (0, projectFiles_1.removeTemplateFilesAsync)(projectDir);
...
class New extends EasCommand_1.default {
    ...
    async runAsync() {
        ...
        let template = flags['sdk-version']
            ? await (0, sdkVersion_1.resolveTemplateAsync)({ sdkVersion: flags['sdk-version'] })
            : null;
        ...
        template ??= await (0, sdkVersion_1.resolveTemplateAsync)({});
        const projectDirectory = await (0, commands_1.downloadTemplateAsync)(targetProjectDirectory, template);
