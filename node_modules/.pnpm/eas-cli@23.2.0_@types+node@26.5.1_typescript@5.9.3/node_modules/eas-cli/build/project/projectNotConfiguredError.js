...
exports.getUnconfiguredProjectError = getUnconfiguredProjectError;
 ...
 */
function getUnconfiguredProjectError({ actor, accountName, reason = 'This command cannot configure it in non-interactive mode.', additionalFix, }) {
    return new Error(`EAS project not configured. ${reason} ` +
        ...
        `Accounts you can create projects in: ${(0, User_1.getCreatableAccountNames)(actor).join(', ')}` +
        (additionalFix ? `\n\n${additionalFix}` : ''));
}
