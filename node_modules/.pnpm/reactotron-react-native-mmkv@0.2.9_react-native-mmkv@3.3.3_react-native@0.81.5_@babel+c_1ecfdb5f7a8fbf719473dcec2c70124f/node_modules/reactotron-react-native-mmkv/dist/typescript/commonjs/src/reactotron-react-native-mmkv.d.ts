 ...
 */
export default function mmkvPlugin<Client extends ReactotronCore = ReactotronCore>(config: MmkvPluginConfig): (reactotron: Client) => {
    onConnect(): void;
    onDisconnect(): void;
};
//# sourceMappingURL=reactotron-react-native-mmkv.d.ts.map