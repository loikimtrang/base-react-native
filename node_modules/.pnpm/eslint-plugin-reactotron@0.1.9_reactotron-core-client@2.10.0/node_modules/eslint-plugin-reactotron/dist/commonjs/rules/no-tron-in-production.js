...
exports.noTronInProduction = void 0;
var _utils = require("@typescript-eslint/utils");
const createRule = _utils.ESLintUtils.RuleCreator(() => `reactotron/no-tron-in-production`);

/**
 * Enforces `if (__DEV__)` around `console.tron` calls so they are not included in production.
 */
const noTronInProduction = exports.noTronInProduction = createRule({
  ...
  create(context) {
    ...
    return {
      CallExpression(node) {
        ...
        if (callee.type === "MemberExpression" && callee.object.type === "MemberExpression" && callee.object.object.type === "Identifier" && callee.object.object.name === "console" && callee.object.property.type === "Identifier" && callee.object.property.name === "tron") {
          ...
          if (!parent || parent.type !== "IfStatement" || !parent.test || parent.test.type !== "Identifier" || parent.test.name !== "__DEV__") {
            context.report({
              node: callee,
...
//# sourceMappingURL=no-tron-in-production.js.map