...
declare const _default: {
     ...
     */
    initializeApp(options: ReactNativeFirebase.FirebaseAppOptions, appConfig: ReactNativeFirebase.FirebaseAppConfig): Promise<InitializeAppResult>;
    /**
     ...
     */
    metaGetAll(): Promise<Record<string, never>>;
    /**
     ...
     */
    jsonGetAll(): Promise<Record<string, never>>;
    /**
     ...
     */
    preferencesGetAll(): Promise<PreferencesStorage>;
    /**
     ...
     */
    eventsGetListeners(): Promise<ListenersMap>;
    /**
     ...
     * @returns void
     */
    eventsPing(eventName: string, eventBody: any): Promise<any>;
    /**
     * Adds a listener for an event.
     *
     * @param eventName - The name of the event to listen for.
...
//# sourceMappingURL=RNFBAppModule.d.ts.map