...
export default {
   ...
   * @param value - The value to set.
   */
  async preferencesSetString(key, value) {
    fakePreferencesStorage[key] = value;
  },
  /**
   ...
   * @returns void
   */
  async eventsPing(eventName, eventBody) {
