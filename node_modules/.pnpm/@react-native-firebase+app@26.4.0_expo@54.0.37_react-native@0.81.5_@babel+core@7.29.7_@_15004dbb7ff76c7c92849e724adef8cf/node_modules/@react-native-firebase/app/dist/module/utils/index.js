...
import { isIOS, isOther } from "../common/index.js";
import { FirebaseModule, getOrCreateModularInstance } from "../internal/index.js";
import { UTILS_NATIVE_MODULE } from "../internal/constants.js";
...
class FirebaseUtilsModule extends FirebaseModule {
  ...
  get playServicesAvailability() {
    ...
    return this.getPlayServicesStatus();
  }
 ...
 */
export function getUtils(app) {
  return getOrCreateModularInstance(FirebaseUtilsModule, config, app);
}
