...
exports.EasCliVersionsFetchTimeoutError = exports.EasCliNpmTags = exports.CustomBuildConfigSchema = exports.JobOutputsSchemaZ = exports.JobOutputsSchema = exports.StaticWorkflowInterpolationContextZ = exports.CacheSchema = exports.SshSettingsZ = exports.SshSettingsSchema = exports.HooksZ = exports.HooksSchema = exports.EnvironmentSecretZ = exports.EnvironmentSecretsSchema = exports.EnvironmentSecretType = exports.EnvSchema = exports.ArchiveSourceSchemaZ = exports.ArchiveSourceSchema = exports.BuildTrigger = exports.ArchiveSourceType = exports.Platform = exports.Workflow = exports.BuildMode = void 0;
exports.fetchEasCliVersionsAsync = fetchEasCliVersionsAsync;
...
exports.SshSettingsSchema = joi_1.default.object({
    idleTimeoutSeconds: joi_1.default.number().integer().min(0).max(3600).required(),
    relayServerUrl: joi_1.default.string()
        .uri({ scheme: ['ws', 'wss'] })
        .required(),
});
exports.SshSettingsZ = zod_1.z.object({
    idleTimeoutSeconds: zod_1.z.number().int().min(0).max(3600),
    relayServerUrl: zod_1.z.url({ protocol: /^wss?$/ }),
});
...
const AppStoreConnectContextZ = zod_1.z.looseObject({
    ...
    build_upload: zod_1.z
        ...
        cf_bundle_short_version_string: zod_1.z.string().optional(),
        platform: zod_1.z.string().optional(),
        uploaded_date: zod_1.z.string().optional(),
...
const SemverStringZ = zod_1.z
    .string()
    .refine(value => semver_1.default.valid(value) !== null, { message: 'Expected a valid semver version.' });
const EasCliVersionsZ = zod_1.z.object({
 ...
 */
class EasCliVersionsFetchTimeoutError extends Error {
    constructor(url, timeoutMs) {
        super(`Timed out after ${timeoutMs}ms fetching ${url}.`);
        this.name = 'EasCliVersionsFetchTimeoutError';
    }
}
exports.EasCliVersionsFetchTimeoutError = EasCliVersionsFetchTimeoutError;
/**
 ...
 */
async function fetchEasCliVersionsAsync() {
