...
export declare class BuildStepContext {
    ...
    readonly logger: bunyan;
    private _relativeWorkingDirectory?;
    constructor(ctx: BuildStepGlobalContext, { logger, relativeWorkingDirectory, }: {
        logger: bunyan;
        relativeWorkingDirectory?: string;
    });
    get relativeWorkingDirectory(): string | undefined;
    updateRelativeWorkingDirectory(value: string | undefined): void;
