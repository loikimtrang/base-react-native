...
class BuildStepGlobalContext {
    ...
    buildStepsInterpolationMap() {
        return Object.fromEntries(Object.values(this.stepById)
...
class BuildStepContext {
    ...
    get relativeWorkingDirectory() {
        return this._relativeWorkingDirectory;
    }
    updateRelativeWorkingDirectory(value) {
