...
export declare class BuildStepInput<T extends BuildStepInputValueTypeName = BuildStepInputValueTypeName, R extends boolean = boolean> {
    ...
    getValue({ interpolationContext, skipLegacyOutputInterpolation, }: {
...
export declare function getDisallowedInputValueError(input: BuildStepInput, stepDisplayName: string): string | undefined;
