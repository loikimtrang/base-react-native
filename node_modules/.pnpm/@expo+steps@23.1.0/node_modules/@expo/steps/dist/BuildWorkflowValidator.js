...
function validateInputs(steps) {
    ...
    for (const currentStep of steps) {
        for (const currentStepInput of currentStep.inputs ?? []) {
            ...
            const disallowedValueError = (0, BuildStepInput_1.getDisallowedInputValueError)(currentStepInput, currentStep.displayName);
            if (disallowedValueError) {
                errors.push(new errors_1.BuildConfigError(disallowedValueError));
            }
